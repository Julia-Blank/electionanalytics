...
stargazerplot <- stargazer(midtermmodelturnout, midtermmodelturnout_incumb, midtermmodelturnout_rate_incumb,linearmodelnat, type = "text", title="National Linear Models Regression Results", dep.var.labels = "Democratic Vote Percentage",
