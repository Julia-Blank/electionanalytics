...
library(tidyverse)
setwd("/Users/juliablank/Documents/GOV 50 PROJECTS/electionanalytics/03-Polling (9-22)/section data")
poll_df <- read_csv("/Users/juliablank/Documents/GOV 50 PROJECTS/electionanalytics/03-Polling (9-22)/section data/polls_df.csv") # replace with your own wd() 
...
library(tidyverse)
poll_df <- read_csv("/Users/juliablank/Documents/GOV 50 PROJECTS/electionanalytics/03-Polling (9-22)/section data/polls_df.csv")
```
...
popvote_df <- read_csv("Section data/H_popvote_df_fin.csv") # replace with own wd()
poll_df <- read_csv("~/Section data/polls_df.csv")
