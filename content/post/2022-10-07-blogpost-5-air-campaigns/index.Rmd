...
```{r,echo = FALSE, message = FALSE, warning = FALSE, options(warn=1)}
...
$$ DemVotesMajorPercent = Avgerag Ad Spend*b_1 + DemStatus*b_2$$
$$ RepVotesMajorPercent = Avgerag Ad Spend*b_1 + RepStatus*b_2$$
